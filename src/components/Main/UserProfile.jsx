          ...
          <div className="col-span-4 sm:col-span-3">
            <div className="bg-white shadow rounded-lg p-6">
              <div className="flex flex-col items-center">
                ...
                <span className="text-center mt-5 bg-white">{userData.email}</span>
              ...
              <div className="flex flex-col">
                ...
                <ul className="list-disc list-inside">
                  <li className="pb-2 ml-4">{userData.skill1}</li>
                  <li className="pb-2 ml-4">{userData.skill2}</li>
                  <li className="pb-2 ml-4">{userData.skill3}</li>
                  <li className="pb-2 ml-4">{userData.skill4}</li>
                </ul>
              </div>
            </div>
          </div>
                    ...
                    <div class="col-span-9">
                        ...
                        <div class="bg-white shadow rounded-lg p-6">
                            ...
                            <div class="flex justify-center items-center gap-6 my-6">
                                <Link class="text-gray-700 hover:text-orange-600" aria-label="Visit TrendyMinds LinkedIn" href=""
                                    target="_blank">
                            ...
                            <div class="mb-6">
                                <div class="flex justify-between flex-wrap gap-2 w-full">
                                    {/* Main */}
                                    <input value={userData.experience2} readOnly disabled className='bg-white'/>
                                    {/* Description  */}
                                    <p>
                                        {/* Last work place  */}
                                        <span class="text-gray-700 mr-2">{userData.workplace2}</span>
                                        {/* Year  */}
                                        <span class="text-gray-700">{userData.year2}</span>
                                    </p>
                                </div>
                                <p class="mt-2">
                            ...
                            <div class="mb-6">
                                <div class="flex justify-between flex-wrap gap-2 w-full">
                                    {/* Main */}
                                    <input value={userData.experience3} readOnly disabled className='bg-white'/>
                                    {/* Description  */}
                                    <p>
                                        {/* Last work place  */}
                                        <span class="text-gray-700 mr-2">{userData.workplace3}</span>
                                        {/* Year  */}
                                        <span class="text-gray-700">{userData.year3}</span>
                                    </p>
                                </div>
                                <p class="mt-2">
                            ...
                            <div class="mb-6">
                                <div class="flex justify-between flex-wrap gap-2 w-full">
                                    {/* Main */}
                                    <input value={userData.experience4} readOnly disabled className='bg-white'/>
                                    {/* Description  */}
                                    <p>
                                        {/* Last work place  */}
                                        <span class="text-gray-700 mr-2">{userData.workplace4}</span>
                                        {/* Year  */}
                                        <span class="text-gray-700">{userData.year4}</span>
                                    </p>
                                </div>
                                <p class="mt-2">
                                    {userData.description5}
                                </p>
                            </div>
                        </div>
                    </div>
